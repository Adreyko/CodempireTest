...
import {
  setSortByName,
  setSortByTotal,
} from "../redux/store/dataSlice/dataSlice";
...
const CountryList = () => {
  ...
  const sortedByConfirmed = data
    ? [...data]?.sort((a: ICountries, b: ICountries) =>
        sortedByLeast
    ...
    <div>
      <div className="bg-blue-400 h-12 rounded-xl text-white   flex justify-between items-center px-4  mx-16">
        <div className="flex  h-full items-center ">
          ...
          <h1 className="px-4 cursor-pointer" onClick={sortyByName}>
            Country
          </h1>
        </div>
        <div className="flex  h-full items-center">
          <div className="h-full border-l-[1px] flex items-center">
            <h1
              className="px-4 pr-20 cursor-pointer"
